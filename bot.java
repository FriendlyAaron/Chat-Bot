...
public class bot extends JFrame{
  ...
  Chatarea,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
  ...
  public bot() {  
   ...
   Chatbox.addActionListener(new ActionListener() {  		
    	...
    	//Greetings
    	if (gtext.contains("hi")|| gtext.contains("hello")|| gtext.contains("howdy")|| gtext.contains("hey")|| gtext.contains("heyy")|| gtext.contains("sup")) {
    	...
    	if (gtext.contains("how its going")|| gtext.contains("whats up")|| gtext.contains("whats going on")|| gtext.contains("whats happening")|| gtext.contains("what are you doing")|| gtext.contains("hows it going")|| gtext.contains("whats going on")) {
